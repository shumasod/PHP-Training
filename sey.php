...
// セットアップ手順
/*
1. サービスプロバイダーを登録 (config/app.php)
'providers' => [
    // ...
    App\Providers\SqlCorrectorServiceProvider::class,
],

2. ルートを追加 (routes/api.php)
...
3. Webルートを追加 (routes/web.php)
Route::get('/sql-corrector', function () {
    return view('sql-corrector');
});

4. Artisanコマンドを登録 (app/Console/Kernel.php)
protected $commands = [
    App\Console\Commands\SqlCorrectorCommand::class,
];

5. 各ファイルを適切な場所に配置:
- app/Services/SqlSyntaxCorrectorService.php
- app/Http/Controllers/SqlCorrectorController.php
- app/Console/Commands/SqlCorrectorCommand.php
- app/Providers/SqlCorrectorServiceProvider.php
- resources/views/sql-corrector.blade.php
*/
...
1. コマンドラインでの使用:
php artisan sql:correct "SELECT FROM users"

2. APIでの使用:
POST /api/sql-corrector/correct
{
    "sql": "SELECT FROM users"
}

3. Webインターフェースでの使用:
http://your-app.com/sql-corrector
