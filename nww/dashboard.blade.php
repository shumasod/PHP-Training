...
<body class="bg-gray-100 font-sans">
    ...
    <main class="container mx-auto mt-8">
        <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p class="text-gray-700 text-center mb-6">管理画面</p>
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="p-12 md:w-1/2 flex flex-col items-start">
            <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest" style="background-color: rgb(193, 230, 198); border-color: rgba(0, 0, 0, 0.35);">CATEGORY</span>
        ...
        <div class="p-12 md:w-1/2 flex flex-col items-start">
            ...
            <footer class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    ...
                    <div class="bg-gray-100" style="background-color: rgb(193, 230, 198); border-color: rgba(0, 0, 0, 0.35);">
                    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row" style="border-color: rgba(0, 0, 0, 0.35);">
                        <p class="text-gray-500 text-sm text-center sm:text-left" style="border-color: rgba(0, 0, 0, 0.35);">© 2020 Tailblocks —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank" style="border-color: rgba(0, 0, 0, 0.35);">@knyttneve</a>
                        </p>
                        <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start" style="border-color: rgba(0, 0, 0, 0.35);">
                        <a class="text-gray-500" style="border-color: rgba(0, 0, 0, 0.35);">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a class="ml-3 text-gray-500" style="border-color: rgba(0, 0, 0, 0.35);">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
